...
class GeminiLiveHandler(ConversationHandler):
    """Gemini Live API handler for robot audio streams."""
    ...
    def __init__(
        ...
        logger.warning("Gemini Live backend is legacy-only in this production build.")
        self.deps = deps
    ...
    async def apply_personality(self, profile: str | None) -> str:
        """Apply a new profile at runtime.
        ...
        try:
            ...
            if self.session is not None:
                try:
                    ...
                    return "Applied profile and restarted Gemini session."
